...
class BasePage:
    ...
    def go_to_basket_page(self):
        ...
        self.browser.find_element(*BasketPageLocators.BASKET_LINK_PAGE).click()
        print(self.browser.current_url)
        #return BasketPage(self.browser, self.browser.current_url) # переход на страницу корзины
